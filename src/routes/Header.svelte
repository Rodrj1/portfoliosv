...
<header
	class="fixed w-full bottom-0 md:top-0 md:bottom-auto h-auto sm:min-h-[75px] bg-zinc-900 md:bg-transparent rounded-b-lg m-auto z-50 backdrop-blur-sm"
>
	<nav>
		<ul
		...
		>
			...
			<li class={`${path === '/about' && '!border-b !border-sky-500'}`}>
				<a
					href="/about"
			...
			<li class={`${path.includes('projects') && '!border-b !border-sky-500'}`}>
				<a
					href="/projects"
