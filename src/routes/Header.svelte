...
>
	<nav>
		<ul
			class="flex sm:flex-row justify-between sm:justify-end py-2 gap-1 sm:gap-4 xl:gap-16 list-none h-auto border-t border-gray-500 sm:border-transparent p-0 lg:min-h-[50px] backdrop-blur-sm w-[95%] m-auto font-sans"
		>
